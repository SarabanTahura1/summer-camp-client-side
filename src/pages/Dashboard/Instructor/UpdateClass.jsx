...
const UpdateClass = () => {
  ...
  const onSubmit = (data) => {
    axios
      .put(`https://language-server.up.railway.app/update/${classData._id}`, {
        ...data,
      })
      .then((response) => {
        if (response.data.modiefiedCount > 0) {
          return Swal.fire({
            icon: "success",
          ...
          Swal.fire({
            icon: "error",
            title: "You are not doing any change any field",
            text: "Ooopps...",
            showConfirmButton: false,
            timer: 2000,
          });
        ...
        <div className="space-y-4">
          <div>
            <input
              ...
              defaultValue={classData.courseFees}
              className="bg-gray-100 p-4 border-0 text-gray-500 focus:border-0 focus:outline-0 rounded w-full placeholder:text-gray-400"
          ...
          <div>
            <input
              ...
              defaultValue={classData.courseImage}
              className="bg-gray-100 p-4 border-0  text-gray-500 focus:border-0 focus:outline-0 rounded w-full placeholder:text-gray-400"
